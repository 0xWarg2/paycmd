...
keywords: ["pay", "contacts", "recipient", "preview", "50 seconds", "AskPayna"]
tutorial: true
aiSummary:
  - "A Payna payment requires amount, recipient, source chain, and destination chain, then shows a 50-second confirmation preview before Gateway execution."
