  ...
  return (
    <main className="relative h-dvh overflow-y-auto overflow-x-hidden scroll-smooth bg-[#07090d] text-[#f4f7f8]">
      <div className="pointer-events-none fixed inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,#07090d_0%,rgba(7,9,13,.86)_36%,rgba(7,9,13,.62)_72%,#07090d_100%)]" />
      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#07090d]/72 backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 md:px-8">
          <Link href="/" className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="truncate text-xs text-white/48">AI stablecoin copilot</div>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button asChild className="paycmd-button-shine rounded-full bg-white px-5 text-[#07090d] shadow-[0_16px_50px_rgba(99,244,200,.18)] hover:bg-[#dffdf5]">
              <Link href="/app">
                Launch
      ...
      <section className="relative z-10 mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-10 px-5 py-16 md:grid-cols-[minmax(0,1fr)_minmax(360px,540px)] md:px-8 md:py-24">
        <div className="max-w-3xl">
          <div className="paycmd-reveal mb-5 inline-flex items-center gap-2 rounded-full border border-[#63f4c8]/40 bg-[#63f4c8]/10 px-4 py-2 text-sm text-[#caffee] shadow-[0_0_36px_rgba(99,244,200,.08)] backdrop-blur">
          ...
          <p className="paycmd-reveal paycmd-reveal-delay-2 mt-6 max-w-2xl text-lg leading-8 text-white/66">
          ...
          <div className="paycmd-reveal paycmd-reveal-delay-3 mt-9 flex flex-col gap-3 sm:flex-row">
            <Button asChild size="lg" className="paycmd-button-shine h-14 rounded-full bg-[#f4f7f8] px-8 text-base text-[#07090d] shadow-[0_20px_60px_rgba(99,244,200,.18)] hover:bg-[#dffdf5]">
              <Link href="/app">
                Open Payna
          ...
          <div className="paycmd-reveal paycmd-reveal-delay-3 mt-10 grid max-w-2xl gap-3 text-sm text-white/58 sm:grid-cols-3">
            {["Pay contacts", "Bridge USDC", "Record proof"].map((item) => (
              <div key={item} className="payna-subtle-lift flex items-center gap-2 rounded-full border border-white/8 bg-white/[0.045] px-3 py-2 backdrop-blur transition hover:border-[#63f4c8]/35 hover:text-white">
      ...
      <section id="product" className="relative z-10 border-y border-white/8 bg-white/[0.025] py-20 backdrop-blur">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="max-w-2xl">
            <div className="mb-3 flex items-center gap-2 text-sm font-medium text-[#63f4c8]">
            ...
            {capabilities.map((item) => {
              ...
              return (
                <div key={item.title} className="payna-glass payna-subtle-lift rounded-3xl p-5">
                  <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-2xl border border-[#63f4c8]/25 bg-[#63f4c8]/10 text-[#63f4c8]">
          ...
          <div className="payna-glass rounded-3xl p-5">
            <div className="grid gap-3">
              {flowSteps.map((step, index) => (
                <div key={step} className="flex items-center gap-3 rounded-2xl border border-white/8 bg-white/[0.035] px-4 py-3">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[#63f4c8]/12 text-sm font-semibold text-[#63f4c8]">
                    {index + 1}
                  </span>
      ...
      <section id="stack" className="relative z-10 border-t border-white/8 bg-[#07090d]/70 py-20">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="grid gap-10 md:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {stackItems.map((item) => (
                <div key={item.label} className="payna-subtle-lift rounded-2xl border border-white/10 bg-white/[0.04] p-4 backdrop-blur">
                  <div className="flex items-center gap-2 text-sm font-semibold">
                    <BadgeCheck className="h-4 w-4 text-[#63f4c8]" />
                    {item.label}
                  </div>
        ...
        <div className="payna-glass mx-auto max-w-7xl overflow-hidden rounded-[2rem] p-8 md:p-12">
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Button asChild size="lg" className="paycmd-button-shine h-14 rounded-full bg-white px-8 text-base text-[#07090d] hover:bg-[#dffdf5]">
      ...
      <footer className="relative z-10 border-t border-white/8 px-5 py-8 text-sm text-white/42 md:px-8">
